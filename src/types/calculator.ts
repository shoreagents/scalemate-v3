...
import type { LocationData, ManualLocation, IPLocationData } from './location';
...
export type { LocationData, ManualLocation, IPLocationData };
...
export interface DetailedSavingsComparison {
  ...
  readonly localCountry: LocationData;
  readonly localCost: {
